...
fn convert_glif() {
    ...
    let nibglif: glifparser::Glif<()> = glifparser::read_ufo_glif(&fs::read_to_string("nib2.glif").unwrap());
    eprintln!("Reading path...");
    let ssglif: glifparser::Glif<()> = glifparser::read_ufo_glif(&fs::read_to_string("Q_.glif").unwrap());
