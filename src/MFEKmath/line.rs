...
/// This code is straight from flo-curves just modified to accept our structures.
...
/// 
pub fn line_coefficients_2d_unnormalized(line: Line) -> (f64, f64, f64) {
    // Compute the offset 
...
/// This will return (0,0,0) for a line where the start and end point are the same.
/// 
pub fn line_coefficients_2d(line: Line) -> (f64, f64, f64) {
